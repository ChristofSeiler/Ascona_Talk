...
We build one model and perform inference of parameters using Stan. This way we will carry over uncertainty. Try Correlated Topic Model for theta (in transformed parameters block).
